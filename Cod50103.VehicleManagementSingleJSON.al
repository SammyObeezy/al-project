codeunit 50103 "Vehicle Management Single JSON"
{
    procedure HandleRequest(JSONData: Text): Text
    var
    ...
    begin
        ...
        */
        ...
        // We use switch case statement below to determine the logic/procedure to be executed based on the action specified in the request
        case RequestAction.AsValue.AsText of
            'CREATE_VEHICLE_TYPE_REQUEST':
                begin
                    /*
                    {
                        "action": "CREATE_VEHICLE_TYPE_REQUEST",
                        "payload": {
                            "brand_name":"Volkswagen Beatle",
                            "description":"Volkswagen Beatle",
                    ...
                    */
                    ...
                    // Forward the request payload data to procedure CreateVehicleTypeJSON for further processing
                    exit(CreateVehicleTypeJSON(RequestPayload))
                end;
            'CREATE_VEHICLE_REQUEST':
                begin
                    /*
                    {
                        "action": "CREATE_VEHICLE_REQUEST",
                        "payload": {
                            "vehicle_type_no": 18,
                    ...
                    */
                    ...
                    // Forward the request payload data to procedure CreateVehicleJSON for further processing
                    exit(CreateVehicleJSON(RequestPayload))
                end;
            'GET_VEHICLE_TYPES_REQUEST':
                begin
                    /*
                    {
                        "action": "GET_VEHICLE_TYPES_REQUEST"
                    }
                    */
                    exit(GetVehicleTypesJSON())
                end;
            'GET_VEHICLES_REQUEST':
                begin
                    /*
                    {
                        "action": "GET_VEHICLES_REQUEST"
                    }
                    */
                    exit(GetVehiclesJSON())
                end;
            'GET_VEHICLE_TYPE_REQUEST':
                begin
                    /*
                    {
                        "action": "GET_VEHICLE_TYPE_REQUEST",
                        "payload": {
                            "vehicle_type_no": 1
                        }
                    }
                    */
                    ...
                    exit(GetVehicleTypeJSON(RequestPayload))
                end;
            'GET_VEHICLE_REQUEST':
                begin
                    /*
                    {
                        "action": "GET_VEHICLE_REQUEST",
                        "payload": {
                            "vehicle_no": 1
                        }
                    }
                    */
                    ...
                    exit(GetVehicleJSON(RequestPayload))
                end;
            'UPDATE_VEHICLE_TYPE_REQUEST':
                begin
                    /*
                    {
                        "action": "UPDATE_VEHICLE_TYPE_REQUEST",
                        "payload": {
                            "vehicle_type_no": 20,
                    ...
                    */
                    ...
                    // Forward the request payload data to procedure UpdateVehicleTypeJSON for further processing
                    exit(UpdateVehicleTypeJSON(RequestPayload))
                end;
            'UPDATE_VEHICLE_REQUEST':
                begin
                    /*
                    {
                        "action": "UPDATE_VEHICLE_REQUEST",
                        "payload": {
                            "vehicle_no": 16,
                            "vehicle_type_no": 26,
                    ...
                    */
                    ...
                    // Forward the request payload data to procedure UpdateVehicleJSON for further processing
                    exit(UpdateVehicleJSON(RequestPayload))
                end;
            'DELETE_VEHICLE_TYPE_REQUEST':
                begin
                    /*
                    {
                        "action": "DELETE_VEHICLE_TYPE_REQUEST",
                        "payload": {
                            "vehicle_type_no": 1
                        }
                    }
                    */
                    ...
                    exit(DeleteVehicleTypeJSON(RequestPayload))
                end;
            'DELETE_VEHICLE_REQUEST':
                begin
                    /*
                    {
                        "action": "DELETE_VEHICLE_REQUEST",
                        "payload": {
                            "vehicle_no": 1
                        }
                    }
                    */
                    ...
                    exit(DeleteVehicleJSON(RequestPayload))
                end;
            else
                // JSON response to be sent for unknown/unsupported actions
                exit(UnsupportedAction(RequestAction.AsValue.AsText))
        end;
    end;

    // 'local' procedure so that the procedure is NOT directly accessible via the SOAP Web Service
    ...
    begin
        ...
        ResponseObject.Add('status_description', 'The requested action ' + RequestAction + ' is NOT supported.');
    ...
    local procedure CreateVehicleTypeJSON(
    RequestPayload: JsonToken
): Text
    var
    ...
    begin
        ...
        */
        RequestPayload.SelectToken('$.brand_name', RequestBrandName);
        RequestPayload.SelectToken('$.description', RequestDescription);
        RequestPayload.SelectToken('$.logo_image', RequestLogoImageB64);
        RequestPayload.SelectToken('$.parent_brand_no', RequestParentBrandNo);
    ...
    begin
        ...
        {
            "vehicle_type_no": 35,
            "description":"2022 Black Nissan GTR",
            "registration_no": "REG888"
        }
        */
        RequestPayload.SelectToken('$.vehicle_type_no', RequestVehicleTypeNo);
        RequestPayload.SelectToken('$.description', RequestDescription);
        RequestPayload.SelectToken('$.registration_no', RequestRegistrationNo);
    ...
    begin
        ...
        */
        RequestPayload.SelectToken('$.vehicle_no', RequestVehicleNo);
